...
try:
    ...
    - СТРОГО ЗАПРЕЩЕНО: Никогда не используй приветствия ("Здравствуй", "Привет", "Добрый день" и т.п.). Вместо этого начинай с теплого обращения (например: "Искатель истины...", "Творец своей реальности...") или сразу с сути ответа.
    """
...
7. СТРОГО ЗАПРЕЩЕНО: Никогда не начинай с фраз вроде "Здравствуй", "Привет", "Добрый день" и любых других приветствий. Начинай сразу с обращения к собеседнику (например: "Искатель истины...", "Творец своей реальности...") или сразу с сути ответа.
...
async def generate_personalized_response(
    ...
    if not client:
        ...
        return f"К сожалению, я не могу сейчас сгенерировать персонализированный ответ. {error_msg}"
...
7. СТРОГО ЗАПРЕЩЕНО: Никогда не начинай с фраз вроде "Здравствуй", "Привет", "Добрый день" и любых других приветствий. Начинай сразу с обращения к собеседнику (например: "Искатель истины...", "Творец своей реальности...") или сразу с сути ответа.
8. ОБЯЗАТЕЛЬНО используй символ ⸻ для разделения блоков текста
9. НИКОГДА не используй звездочки (**) вокруг слов или фраз. Выделяй важные моменты с помощью других способов форматирования, например, использованием дефисов, абзацев или символа ⸻.
...
"""
        ...
        # Удаляем двойные звездочки (**) из ответа
        ...
        return f"""К сожалению, я сейчас испытываю технические трудности при формировании ответа на твой запрос.
