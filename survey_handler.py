...
def generate_unique_advice(profile_text: str, personality_type: str, history: list) -> str:
    ...
    import random
    emoji_list = emoji_map.get(personality_type, emoji_map["Интеллектуальный"])
    ...
    # Выбираем ключевой аспект, технику и контекст
    aspect = random.choice(aspects)
    technique_list = techniques.get(personality_type, techniques["Интеллектуальный"])
    technique = random.choice(technique_list)
    context_list = contexts.get(personality_type, contexts["Интеллектуальный"])
    ...
    # Выбираем результат
    result_list = results.get(personality_type, results["Интеллектуальный"])
...
def extract_key_aspects(profile_text: str, personality_type: str) -> list:
    ...
    if found_keywords:
        ...
        if dominant_type != personality_type:
            combined_aspects = aspects[personality_type] + aspects[dominant_type]
            return combined_aspects
        
        return aspects[personality_type]
